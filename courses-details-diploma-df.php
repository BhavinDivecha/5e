...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Courses Details || FIAAT</title>
    ...
    <body>
        ...
        <div class="as-mainwrapper">
            ...
            <div class="bg-white">
                ...
                <!--Course Area End-->
                <div class="about-area mt-30 mb-50">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="about-container">
                                    <h3><span class="orange-color">Houdini Advanced FX</span></h3>
                                    <p><h2></h2><br>
Start Date - 10, January, 2023.<br>
Software - Houdini fx and Nuke<br>
Course Duration - 3 months + 1 month Tech support<br>
For queries/ To enroll, call us on- 91+ 9967767425/ 91+ 9004967425.<br>
mail us at - fiaat.5elements@gmail.com</p>
                                </div>
                            </div>
